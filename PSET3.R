...
#############################3333
#Agregamos variables con anÃ¡lisis de textos
...
#Para bogotÃ¡ vamos a agregar estaciones de transmilenio y universidades pensando 
# en que en esta zona vive poblaciÃ³n universitaria
######
...
####Distancia a una estaciÃ³n de transmilenio
dist_tra <- st_distance(x=train_nevera$geometry, y=transmi_rolos_new)
dist_tra

####Distancia mÃ­nima a una estaciÃ³n de transmileni
...
##El poblado en medellÃ­n es una zona rosa turÃ­stica, por esta razÃ³n buscaremos cercanÃ­a a restaurantes
# y parques
...
##Creamos el mapa en OSM para MedellÃ­n
leaflet() %>% 
  addTiles()%>%
